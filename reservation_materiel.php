                ...
                <div id="panel" class="d-flex flex-column bg-light w-50">
                    <div>
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active" data-bs-toggle="tab" href="#Caen">Caen<span><i class="fas fa-hippo px-2"></i></span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#Rouen">Rouen<span><i class="fas fa-otter px-2"></i></span></a>
                            </li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                        <div class="tab-pane container active" id="Caen">...</div>
                        <div class="tab-pane container fade" id="Rouen">...</div>
                        </div>
                    </div>
                </div>
            </div>	
...
<!-- Empty.js -->
<script type="text/javascript" src="js/reservation_materiel.js" ></script>
