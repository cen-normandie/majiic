                    ...
                    <div class="d-flex w-100">
                        <div class="d-flex flex-column col-md-4 col-lg-3 m-2 p-2 border rounded bg-light">
                            ...
                            <div class="d-flex flex-column w-100">
                                ...
                                <button id="export_2026" type="button" class="btn btn-outline-success shadow my-2 mx-4"><i class="fas fa-file-excel pr-2"></i> 2026</button>
                            </div>
                        </div>
                        <div class="d-flex flex-column col-md-4 col-lg-3 m-2 p-2 border rounded bg-light">
                            ...
                            <div class="d-flex flex-column w-100">
                                ...
                                <button id="export_p_2026" type="button" class="btn btn-outline-success shadow my-2 mx-4"><i class="fas fa-file-excel pr-2"></i> 2026</button>
                            </div>
                        </div>
                    </div>
                </div>
