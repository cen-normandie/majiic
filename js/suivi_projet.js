    ...
    for (const actions in actions_f) {
        ...
        <div class="d-flex flex-column w-100 p-2 m-2 border border-success rounded">
            <div class="d-flex w-100 gx-1 align-items-center justify-content-between ">
                ...
                <div class="col-xs-1">
                    <button id="add_p_action_${actions_f[actions].id_action}" id_action="${actions_f[actions].id_action}" class=" bg-light border-0 text-success fs-6 m-1 px-1" ><i class="fas fa-user-plus"></i></button>
...
function get_action_content () {
        ...
        <div class="d-flex flex-column w-100 p-2 m-2 border border-success rounded">
            <div class="d-flex w-100 gx-1 align-items-center justify-content-between ">
                ...
                <div class="col-xs-1">
                    <button id="add_p_action_${c_actions}" id_action="" class=" bg-light border-0 text-success fs-6 m-1 px-1" ><i class="fas fa-user-plus"></i></button>
