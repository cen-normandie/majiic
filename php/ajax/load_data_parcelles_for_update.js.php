...
FROM (SELECT row_to_json(lp) As properties
  FROM $parcelles As lg 
      ...
      ON lg.id_unique = lp.id_unique AND lp.id_site = '".$_POST["id_site"]."' order by lg.id_unique ) As data )  As fc ;
";

//coalesce(id_acquisition, id_convention,id_ore,id_bail_emphy,id_bail_rural, id_pret_a_usage) as doc_reference, 
