...
$result = pg_prepare($dbconn, "sql", 
    "
    UPDATE $progecen_actions set personnes = $2, nb_h_previ = $3 WHERE id_action = $1;
    "
);

$result = pg_execute($dbconn, "sql", array($id_action,$personne,$nb_h_previ)) or die ( pg_last_error());
pg_close($dbconn);
