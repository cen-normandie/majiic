...
SELECT 
    e.e_id, 
    e.e_objet, 
    $2||to_char(e.e_start::timestamp WITHOUT TIME ZONE , 'YYYY-MM-DD HH24:MI:SS') as start, 
    $2||to_char(e.e_end::timestamp WITHOUT TIME ZONE , 'YYYY-MM-DD HH24:MI:SS') as end, 
    ...
    e.e_salissure,
    e.e_panier,
    $2||to_char(e.e_date_saisie::timestamp WITHOUT TIME ZONE , 'YYYY-MM-DD') as date_saisie,
    $2||to_char(e.e_date_saisie_salissure::timestamp WITHOUT TIME ZONE , 'YYYY-MM-DD') as date_saisie_salissure,
    p.color,
    e.e_personne
